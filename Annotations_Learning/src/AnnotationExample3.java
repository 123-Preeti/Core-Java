...
public class AnnotationExample3 { //annotation above class

    @What(description = "An annotation test method")
    @MyAnno2(str = "Testing", val = 100)
    public static void myMethod() { //annotation above method
        AnnotationExample3 obj  = new AnnotationExample3();
        try {
            Annotation annos[] = obj.getClass().getAnnotations();// it will fetch all the annotations
